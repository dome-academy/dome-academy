  ...
  return (
    ...
    >
      <header className='flex flex-col xl:flex-row divide-y-2 xl:divide-x-2 xl:divide-y-0 divide-neutral-950 dark:divide-slate-50 w-full'>
        <section className='py-20 px-8 md:px-10 lg:py-40 w-full xl:w-3/5'>
          <h1
            className={
              "text-3xl md:text-4xl font-semibold mb-4 text-slate-900 dark:text-slate-100 " +
          ...
          <p className=' text-slate-700 dark:text-slate-300 mt-4  xl:text-lg'>
        ...
        <section className='w-full xl:w-2/5 grid grid-cols-2 grid-rows-2 gap-0'>
          <div className='bg-white/30 h-auto relative aspect-[5/3] xl:aspect-square'>
            <Image
              src='/images/guy-with-laptop.webp'
              alt='Something'
              className='object-cover border-b-2 border-r-2 border-neutral-950 dark:border-slate-50'
              fill
