...
const FeatureCard: FC<PropsWithChildren<FeatureCardInterface>> = ({
  ...
  return (
    <div className='w-full relative group rounded-3xl border-2 border-neutral-950 dark:border-slate-50 bg-neutral-200/50 dark:bg-neutral-800/50 px-4 lg:px-5 overflow-hidden'>
      ...
      >
        ...
        <div className='mt-auto'>
          <Link
            href={link}
            className='inline-flex justify-center items-center  px-4 py-2 text-base min-w-[120px] bg-neutral-800 dark:bg-neutral-200 text-white dark:text-black font-medium'
          >
            {linkText}
          </Link>
        </div>
