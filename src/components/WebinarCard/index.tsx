  ...
  return (
    <Link href={link} className='relative w-full'>
      <div className='h-full group relative before:absolute before:inset-0 before:rounded-[20px] before:border-2 before:border-dashed before:border-neutral-950 dark:before:border-slate-50'>
        <div className='w-full bg-gray-50 dark:bg-slate-950 items-center gap-x-2 rounded-[20px] border-2 border-neutral-950 dark:border-slate-50 transition group-hover:-translate-y-2 group-hover:-translate-x-2 overflow-x-hidden'>
          <figure className='w-full aspect-[5/2] relative overflow-hidden'>
            ...
            <div className='flex justify-between'>
              <div className='flex gap-x-4 items-center'>
                ...
                <div className='block'>
                  <h3
                    className={
                      "font-medium text-base " + ClashDisplay.className
                    }
                  >
                    {speaker.name}
                  </h3>
              ...
              {host ? (
                <div className='flex gap-x-4 items-center'>
                  ...
                  <div className='block'>
                    ...
                    <p className='opacity-60 mt-3'>Host</p>
                  </div>
                </div>
              ) : null}
            </div>
